jQuery(document).ready(function ($) {
    ...
    $(".add-row").on("click", function () {
        ...
        <tr class="gear-row" data-gear-index="${index}">
            ...
            <td>
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input rental-toggle" type="checkbox" role="switch"
                           id="gl-rental-toggle-${index}" name="srs_gloves[gloves][${index}][is_rental]" value="1" checked>
                    <label class="form-check-label" for="gl-rental-toggle-${index}">Rental (multi-day pricing)</label>
                </div>
                ...
                <div class="base-price-wrapper mb-2" style="display:none;">
                    ...
                    <input type="number" step="0.01" class="form-control base-price-input"
                           name="srs_gloves[gloves][${index}][base_price]">
                </div>
            ...
            <td>
                <input type="number" step="0.01" class="form-control extra-price-input" name="srs_gloves[gloves][${index}][prices][extra]">
            </td>
        ...
        $("#gloves-table > tbody tr.gear-row:last .rental-toggle").trigger("change");
    });
    ...
    $("#gloves-table > tbody > tr.gear-row").each(function () {
